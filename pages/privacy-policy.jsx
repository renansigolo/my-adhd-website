...
function PrivacyPolicyContent() {
  return (
    <div className="max-w-7xl my-16 mx-auto px-4 sm:px-6 lg:px-8">
      <div className="sticky top-8 inline-flex items-center p-3 border border-transparent rounded-full shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
        <Link href="/">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div>
          ...
          <p>
            Renan Sigolo Ferreira built the My ADHD app as a Free app. This
            SERVICE is provided by Renan Sigolo Ferreira at no cost and is
          ...
          <p>
            ...
            our Terms and Conditions, which is accessible at My ADHD unless
          ...
          <p>
            ...
            including but not limited to a Photo.
          </p>
          <div>
            <p>
          ...
          <p>
            ...
            not hesitate to contact me at contact@myadhd.app.
          </p>
        </div>
      </div>
    </div>
